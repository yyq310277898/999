...
public class AppInfoController {
	...
	public List<DataDictionary>getDataDictionaryList(String typeCode)
	{
		...
		try {
			dataDictionaries=dataDictionaryService.getDataDictionaryList(typeCode);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public String appinfo(@ModelAttribute("appInfo")AppInfo appInfo)
	{
